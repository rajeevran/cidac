...
module.exports = function(mailType) {
    ...
    var mailDict = {
        ...
        "sendAnswer" :{
            subject : "Send answer for your question",
            html    : require('./sendAnswer'),
        },
        "requestDonation" :{
            subject : "Donation Request",
            html    : require('./requestDonation'),
        },
        "donationMail": {
            subject : "Pay Donation",
            html    : require('./payDonation'),
        }
    }

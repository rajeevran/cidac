                                    ...
                                    <tbody>\
                                        <tr>\
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #666666; text-align:left;line-height: 24px;">\
                                                <p>Hi, {{ fullName }}</p>\
                                                <p><u>Donation Details:</u></p>\
                                                <p>Amount: {{ unit }} {{ amount }}</p>\
                                                <p>Category: {{ donationCategoryName }}</p>\
                                                <p>Message: {{ donationMesssage }}</p>\
                                            </td>\
                                        </tr>\
                                        <tr>\
                                            <td width="100%" height="5"></td>\
            ...
            <td width="100%">\
                <table style="max-width:580px;width:100%;background: {{ site_color }};width:100%;" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">\
                    <tbody>\
                        ...
                        <tr>\
                            <td align="center" valign="middle" style="padding:10px 0;font-family: Helvetica, arial, sans-serif; font-size: 10px;color: #4FC5FA">\
